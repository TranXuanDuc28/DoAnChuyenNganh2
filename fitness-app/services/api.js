...
// - Physical device: replace REACT_NATIVE_API_HOST with your// Determine API host based on environment
...
export const userAPI = {
  ...
  sendFriendRequest: (user_id) => api.post(`/users/friends/request`, { user_id }),
