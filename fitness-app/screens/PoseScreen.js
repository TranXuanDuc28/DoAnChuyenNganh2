...
import {ScrollView, View, Text, TouchableOpacity, Image, ActivityIndicator, Alert, Modal, Dimensions, Platform } from 'react-native';
...
import { styles } from './styles/PoseScreen.styles';
        ...
        {!isRealTimeMode ? (
          <>
            ...
            <View style={styles.buttonRow}>
              <TouchableOpacity style={[styles.captureBtn, styles.firstBtn]} onPress={takeAndEvaluate} disabled={isProcessing}>
                {isProcessing ? (
              ...
              <TouchableOpacity 
                style={[styles.captureBtn, styles.realTimeBtn]} 
            ...
            <View style={styles.buttonRow}>
              <TouchableOpacity 
                style={[styles.captureBtn, styles.secondaryBtn]} 
              ...
              <TouchableOpacity 
                style={[styles.captureBtn, styles.tertiaryBtn]} 
          ...
          <TouchableOpacity 
            style={[styles.captureBtn, styles.stopBtn, styles.firstBtn]} 
...
/*
// Styles moved to ./styles/PoseScreen.styles.js
